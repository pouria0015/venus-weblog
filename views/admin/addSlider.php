...
<div class="form-group mx-sm-3 mb-2">
    ...
    <input type="text" name="name" class="form-control <?= add_class_error($data , 'name'); ?>" placeholder="نام اسلاید را وارد کنید" value="<?= isset($data['requests']['text']) ? $data['requests']['text'] : '' ?>" maxlength="100" minlength="10"  required>
    <span class="invalid-feedback"><?= view_error($data , 'name' , ' نام وارد شده نباید بیشتر از 255 کاراکتر و کمتر از 3 کاراکتر باشد! '); ?></span>
</div>
